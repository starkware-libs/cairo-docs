...
.. comment 1. There is still a TODO. 2. Decision needed on Glossary page; carry accross to here {StarkNet Core contract} vs {StarkNet Core Contract} vs {StarkNet core contract}
