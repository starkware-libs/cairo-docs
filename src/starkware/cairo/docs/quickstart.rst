...
Download the python package (``cairo-lang-0.2.0.zip``) from
https://github.com/starkware-libs/cairo-lang/releases/tag/v0.2.0.
To install it using ``pip``, run::

    pip3 install cairo-lang-0.2.0.zip
...
.. only:: not internal
    ...
    Download the Cairo Visual Studio Code extension (``cairo-0.2.0.vsix``) from
    https://github.com/starkware-libs/cairo-lang/releases/tag/v0.2.0,
    and install it using::

        code --install-extension cairo-0.2.0.vsix
