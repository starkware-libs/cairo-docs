...
class SysCallHandlerBase(ABC):
    ...
    def __init__(self, block_info: BlockInfo, general_config: StarknetGeneralConfig):
    ...
    def get_sequencer_address(self, segments: MemorySegmentManager, syscall_ptr: RelocatableValue):
        ...
        response = self.structs.GetSequencerAddressResponse(
            sequencer_address=self.general_config
...
class BusinessLogicSysCallHandler(SysCallHandlerBase):
    ...
    def __init__(
        ...
        super().__init__(block_info=state.block_info, general_config=general_config)
...
class OsSysCallHandler(SysCallHandlerBase):
    ...
    def __init__(
        ...
        super().__init__(block_info=block_info, general_config=general_config)
